!(function (e, t) {
    ...
    n = {
      ...
      decodeStringToByteArray(e, t) {
        ...
        for (let c = 0; c < e.length; ) {
          ...
          if ((++c, null == a || null == i || null == s || null == o)) throw new l();
          (n.push((a << 2) | (i >> 4)),
            64 !== s &&
            ...
            o
              .then((e) => {
                (i && e.addEventListener('close', () => i()),
                  a &&
                    e.addEventListener('versionchange', (e) => a(e.oldVersion, e.newVersion, e)));
              })
              .catch(() => {}),
            o
          );
  ...
  class we {
    ...
    async triggerHeartbeat() {
      ...
      if (
        (null != (null === (e = this._heartbeatsCache) || void 0 === e ? void 0 : e.heartbeats) ||
          ...
          null !=
            (null === (e = this._heartbeatsCache) || void 0 === e ? void 0 : e.heartbeats))) &&
    ...
    async getHeartbeatsHeader() {
      if (
        ...
        null == (null === (r = this._heartbeatsCache) || void 0 === r ? void 0 : r.heartbeats) ||
  ...
  const Te = Ne;
  ue('@firebase/app-compat', '0.2.25', void 0);
  return (Te.registerVersion('firebase', '10.7.1', 'app-compat-cdn'), Te);
});
