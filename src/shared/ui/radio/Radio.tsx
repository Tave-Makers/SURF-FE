    ...
    return (
      ...
      >
        <input
          ...
          onChange={onChange}
          ref={ref}
          className="checked:border-background-primary border-background-quinary checked:bg-background-primary h-15 w-15 cursor-pointer appearance-none rounded-full border p-5 checked:bg-clip-content disabled:cursor-not-allowed"
          {...rest}
        />
