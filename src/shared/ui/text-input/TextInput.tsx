...
export const TextInput = forwardRef<HTMLInputElement, TextInputProps>((props, ref) => {
  ...
  return (
    <div className="flex h-[2.25rem] w-full flex-1 shrink-0 items-center justify-between rounded-[62.43rem] bg-[var(--color-background-tertiary)] py-[0.37rem] pr-[0.5rem] pl-[0.75rem]">
      <input
        value={value}
