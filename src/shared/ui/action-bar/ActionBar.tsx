    ...
    return (
      <div className="border-border-border-normal bg-background-background-normal-lighter flex w-full items-center gap-10 border-t px-13 pt-13 pb-15">
        ...
        <button
          type="button"
          onClick={handleSend}
          className="bg-background-background-primary group hover:bg-background-background-primary-darker rounded-max flex h-[2rem] w-[2rem] shrink-0 items-center justify-center self-end p-7"
        >
          <SurfIcon
            name="ArrowUp"
            size="l"
