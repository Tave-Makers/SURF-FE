    ...
    return (
      ...
      >
        ...
        <div className="bg-background-secondary group-has-[:checked]:bg-background-primary group-has-[:disabled]:bg-background-secondary relative h-[1.1875rem] w-[1.875rem] rounded-full transition-colors duration-300 group-has-[:focus-visible]:outline-[1.5px] group-has-[:focus-visible]:outline-offset-2">
          {/* 토글 핸들 */}
          <span className="bg-foreground-foreground-accent group-has-[:disabled]:bg-background-secondary-darker absolute top-[0.125rem] left-[0.125rem] h-[0.9375rem] w-[0.9375rem] rounded-full transition-transform duration-300 will-change-transform group-has-[:checked]:translate-x-[0.6875rem]" />
        </div>
        {label && (
